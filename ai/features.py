...
class LexicalFeatureExtractor:
    ...
    CONTENT_WORDS = {
        'english': ['boy', 'girl', 'woman', 'mother', 'child', 'children', 'cookie', 'cookies',
                    'jar', 'stool', 'chair', 'sink', 'water', 'window', 'curtain', 'dish', 'dishes',
                    'fall', 'falling', 'reach', 'reaching', 'wash', 'washing', 'overflow', 'overflowing',
                    'stand', 'standing', 'get', 'getting', 'take', 'taking', 'dry', 'drying',
                    'see', 'look', 'looking', 'kitchen', 'floor', 'counter', 'cupboard'],
        'chinese': ['男孩', '女孩', '女人', '母亲', '孩子', '饼干', '罐子', '凳子', '椅子',
                    '水槽', '水', '窗户', '窗帘', '碗', '盘子', '掉', '落', '够', '洗',
                    '溢出', '站', '拿', '擦', '看', '厨房', '地板'],
        'indonesian': ['anak', 'laki', 'perempuan', 'wanita', 'ibu', 'kue', 'toples', 'bangku',
                    'kursi', 'wastafel', 'air', 'jendela', 'tirai', 'piring', 'jatuh',
                    'ambil', 'cuci', 'meluap', 'berdiri', 'keringkan', 'lihat', 'dapur', 'lantai']
    }
    ...
    FUNCTION_WORDS = {
        'english': ['the', 'a', 'an', 'is', 'are', 'was', 'were', 'be', 'been', 'being',
                    ...
                    'could', 'may', 'might', 'must', 'can', 'shall', 'and', 'or', 'but',
                    'if', 'because', 'as', 'of', 'to', 'for', 'with', 'on', 'in', 'at',
                    'by', 'from', 'up', 'about', 'into', 'through', 'during', 'before',
                    'after', 'above', 'below', 'between', 'under', 'again', 'further',
                    'then', 'once', 'here', 'there', 'when', 'where', 'why', 'how',
                    'all', 'both', 'each', 'few', 'more', 'most', 'other', 'some', 'such',
                    'no', 'nor', 'not', 'only', 'own', 'same', 'so', 'than', 'too', 'very'],
        'chinese': ['的', '了', '在', '是', '和', '与', '或', '但', '如果', '因为',
                    '从', '到', '对', '为', '以', '把', '被', '给', '让', '使',
                    '这', '那', '什么', '谁', '哪', '怎么', '为什么', '都', '也', '还'],
        'indonesian': ['yang', 'dan', 'atau', 'tetapi', 'jika', 'karena', 'dengan', 'dari',
                    'ke', 'untuk', 'pada', 'di', 'oleh', 'adalah', 'ini', 'itu',
                    'apa', 'siapa', 'mana', 'bagaimana', 'mengapa', 'juga', 'masih']
    }
    
    DEICTIC_WORDS = {
        'english': ['this', 'that', 'it', 'thing', 'things', 'stuff', 'something', 
                    'here', 'there', 'one', 'ones'],
        'chinese': ['这', '那', '东西', '事情', '这个', '那个', '这里', '那里', '什么'],
        'indonesian': ['ini', 'itu', 'hal', 'sesuatu', 'di sini', 'di sana', 'satu']
    }
    
    def extract(self, text: Optional[str], speech_duration: float, 
    ...
    def _extract_lexical_density(self, tokens: List[str], lang: str) -> Dict[str, float]:
    ...
    def _extract_speaking_rate(self, text: str, speech_duration: float, 
                               total_duration: float) -> Dict[str, float]:
        ...
        articulation_rate = (syllables / speech_duration) * 60 if speech_duration > 0 else 0
